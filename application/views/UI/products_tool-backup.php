...
<div class="main-container" ng-controller='invCtrl'>
	...
	<div id="dataload" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
	  <div class="card panel ">
		<div class="panel-heading">
		  <button class="close" type="button" data-dismiss="modal">×</button>
		  <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>List of Searches</h3>
		  
		</div>
		<div class="panel-body ">
		  <div class="row">
			<div class="col-sm-12">
			  <table id="productres" class="table table-responsive table-striped dataTable">
			  	<thead>
			  		<tr>
			  			<th>Image</th>
			  			<th>Title</th>
...
<div class="padding-md" style="padding-right:3.5%;">
  <div class="row" >
	...
	<div class="col-sm-11 col-xs-10">
	 ...
	 <div align="center" class="col-lg-12 col-md-6 no-padding" >
	  <h1><i class="fa fa-amazon"></i>  Amazon Tool 2.0</h1>
	  <h3 >Remaining Tokens: <span id="keepa_tokens">9999</span></h3>
	  <div class="form-group contact-search m-b-30">
		<input style="width: 20%;" type="text" onchange="autoSave();" placeholder="Search..." class="form-control" name='search' id="search"><br/>
		<button class="btn btn-sm btn-success" id="findpro"><i class="fa fa-search"></i>&nbsp;&nbsp;&nbsp;Search</button>
	  </div>
	</div>  
  ...
  <div class="col-md-12 my-15">
	<div class="d-flex align-items-center flex-column-sm">
	  <div class="col-md-3 col-xs-12 my-15 d-flex align-items-center justify-content-center" id="loadedImage"></div>
	  <div class="col-md-9 col-xs-12 my-15" id="loadedStats" style="display: none;">
		<div class="table-responsive">
		  <table border="0" class="table prod_detail_table box">
			<tbody>
			  <tr>
				<th><h4>Title</h4></th>
				<th><h4>Amazon Price</h4></th>
				<th><h4>Count</h4></th>
				<th><h4>Offers Data</h4></th>
			  </tr>
				<tr>
					<td>
				...
				<tr>
				  <th colspan="2"><h4>Author</h4></th>
				  <th><h4>New Price</h4></th>
				  <th><h4>Weight</h4></th>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
				  <th colspan="2"><h4>Manufacturer</h4></th>
				  <th colspan="2"><h4>Used Price</h4></th>
				</tr>
				<tr>
					<td colspan="2">
		...
		<!-- <table border=0 width="80%">
		  ...
		  <div class="col-sm-11 col-md-6 no-padding" style="width:100%;margin-right:20px;">
		   <div class="table-responsive">
			...
			<table class="table table-bordered table-actions-bar prod_detail_table box">
			  <thead >
				...
				<tr >
				  ...
				  <th class="br_color" style="width: 50px;text-align: center !important;background-color: #<?php echo $colors['BR'];?>;" ><i class="fa fa-line-chart"></i></th>
				  <th class="br_color" style="width: 40px;text-align: center !important;background-color: #<?php echo $colors['BR'];?>;" ><i class="fa fa-usd"></i></th>
				   <th class="br_color" style="width: 50px;text-align: center !important;background-color: #<?php echo $colors['CN'];?>;" ><i class="fa fa-line-chart"></i></th>
				  <th class="br_color" style="width: 40px;text-align: center !important;background-color: #<?php echo $colors['CN'];?>;" ><i class="fa fa-usd"></i></th>
  ...
  $(document).ready(function(){
	...
	$("#findpro").click(function(){
		...
		if($.isNumeric($("#search").val())){
			...
			$("#dataload").modal('show');
			  ...
			  $.ajax({
			       url: 'http://localhost/green/asset/try.json',
			       dataType: 'json',
	...
	var usedPrice = '$'+parseFloat(data['products'][key]['csv'][2][data['products'][key]['csv'][2].length-1]/100).toFixed(2);
						...
						if(data.products[key].format!=null){
			       		...
			       		var row = "<tr id='"+data.products[key].asin+"'>\n\
...
function localsearch(id) {
  ...
  // }
  var path = "http://localhost/green/products_tool/get_pro/"+id;
  $.ajax({  
   url:path,
   method:"GET",    
   dataType:"json",
  ...
  { 
	...
	//console.log(data[0]['image']);
	  ...
	  var row  = '<tr><td align="center"><img src="'+data[0]['image']+'" alt="" width="50" height="50"></td>';
...
function keepa(id) {
  ...
  { 
	...
	if (data['products'][0]) {
  	...
  	//console.log('Alpha');
  	var path = "https://api.keepa.com/search?key=f4srik0llhm63as1p4bgv4j0vu1m985lbikjeo7btf231h2gvtqjmkf5kq9ahssk&domain=1&type=product&term="+id;
  }
