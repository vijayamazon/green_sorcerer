...
class Amazon_product_api_in extends CI_Model
{
  private $seller_id='';
  private $auth_token='';
  private $access_key='';
  private $secret_key='';
  private $market_id='';
  private $service_url='mws.amazonservices.in';
  ...
  { 
    try
    {
       ...
       if(isset($res->GetLowestOfferListingsForASINResult[0]->Product))
      {
			...
			$payload['low_price']= (((string)$res->GetLowestOfferListingsForASINResult[0]->Product->LowestOfferListings->LowestOfferListing->Price->LandedPrice->Amount)/64.97);
