...
class Amazon_product_api_as extends CI_Model
{
  private $seller_id='';
  private $auth_token='';
  private $access_key='';
  private $secret_key='';
  private $market_id='';
  private $service_url='mws.amazonservices.com.au';
...
public function fetch_product_detail($user_id,$asin)
 ...
 private function built_query_string($add_param)
 {
        ...
        sort($url_parts);
            ...
            $string_to_sign = "POST\nmws.amazonservices.com.au\n/Products/2011-10-01\n" . $url_string;
            
            $signature = hash_hmac("sha256", $string_to_sign, $this->secret_key, TRUE);
            $signature = urlencode(base64_encode($signature));
            $url = "https://mws.amazonservices.com.au/Products/2011-10-01?". $url_string . "&Signature=" . $signature;
            return $url; 
 }
}