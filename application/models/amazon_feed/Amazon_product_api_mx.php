...
class Amazon_product_api_mx extends CI_Model
{
  private $seller_id='';
  private $auth_token='';
  private $access_key='';
  ...
  { 
    try
    {
       ...
       if(isset($res->GetLowestOfferListingsForASINResult[0]->Product))
      {
			...
			$payload['low_price']= (((string)$res->GetLowestOfferListingsForASINResult[0]->Product->LowestOfferListings->LowestOfferListing->Price->LandedPrice->Amount)/18.6008);
